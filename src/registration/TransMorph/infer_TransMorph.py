...
def main(loss_type, dataset):
    exp_dir = f'{TM_dir}/{dataset}/experiments'
    to_dir = f'{TM_dir}/results/{dataset}'
    ...
    test_set = datasets.IXIBrainInferDataset(test_files, atlas_file, transforms=test_composed)
